...
import numpy
from ai.constants import DEPTH_MODEL_CONFIG
...
class DepthAnything:
    ...
    def depth(self, frame) -> numpy.ndarray:
        """
    ...
    def calculate_depth(self, frame, points):
        ...
        depth_values = []
        for point in points:
            depth_values.append(depth[point[1]][point[0]].item())
